...
$('#charcuterie').click(function renderChacuterie(){
 ...
 $('#breakfast').on('click', function(){
  ...
  <div class="course-info">
        ...
        <div class="course-description">
          <p> Our breakfast charucterie board, filled with keto friendly pancakes, breakfast sausage, bacon, eggs, strawberries, blue berries, and rasberries! </p>
        </div>
        <div class="course-price">$24.99 | 10 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#fulfillment').on('click', function(){
  ...
  <div class="course-info">
        <div class="course-name">The Fulfillment</div>
        <div class="course-description">
          <p> Fullfilment charcuterie board, comes with a variety of meat, cheese, nuts, fruit, and chocolate. Kiwi, tomato, dark chocolate, nuts, and more!  </p>
        </div>
        <div class="course-price">$19.99 | 5 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#kiss').on('click', function(){
  ...
  <div class="course-info">
        <div class="course-name">The K.I.S.S</div>
        <div class="course-description">
          <p> A little, meat, cheese, nuts, and fruit. </p>
        </div>
        <div class="course-price">$18.99 | 5 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#berry').on('click', function(){
  ...
  <div class="course-info">
        <div class="course-name">The Very Berry</div>
        <div class="course-description">
          <p> Ultimate,low car fruit charcuterie. Watermelon, blueberries, rasberries, and strawberries. </p>
        </div>
        <div class="course-price">$15.99 | 7 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#lunches').click(function renderLunches(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://mamabearscookbook.com/wp-content/uploads/2019/10/low-carb-beef-stew-feature.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Beef Stew and Keto Rolls </div>
        <div class="course-description">
          <p> Our hearty beef stew, paired with keto friendly rolls. </p>
        </div>
        <div class="course-price">$9.99 | 4 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#cabbage').on('click', function(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://cdn.greatlifepublishing.net/wp-content/uploads/sites/2/2017/02/22121653/Kielbasa-Fried-Cabbage-Horizontal-5.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Cabbage and Sasuage Bowl</div>
        <div class="course-description">
          <p> Our smothered cabbage, cooked with smoked sausage </p>
        </div>
        <div class="course-price">$7.99 | 3 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#meatballs').on('click', function(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://ketopots.com/wp-content/uploads/2020/02/5a-keto-spaghetti.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Meatballs with Egg Noodles</div>
        <div class="course-description">
          <p> Our house rolled meatballs covered in pasta sauce, over a bed of egg noodles.</p>
        </div>
        <div class="course-price">$11.99 | 8 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#meatloaf').on('click', function(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://i2.wp.com/homemadeinterest.com/wp-content/uploads/2018/01/Low-Carb-Meatloaf_featured-FB.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Meatloaf</div>
        <div class="course-description">
          <p> Our slow cooked meatload, covered in brown gravy.</p>
        </div>
        <div class="course-price">$6.99 | 5 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#kids').click(function renderKids(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://www.thedietchefs.com/wp-content/uploads/2019/04/Keto-Pizza-in-10-MINUTES-This-the-is-BEST-Pizza-for-keto-SO-MUCH-BETTER-than-Fat-head-Crust-Pizza.png"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Pizza Slice </div>
        <div class="course-description">
          <p> Large slice of pepperoni pizza, with crust made of cheese. </p>
        </div>
        <div class="course-price">$5.99 | 1 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#nuggets').on('click', function(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://webknox.com/recipeImages/983213-556x370.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Chicken Nuggets</div>
        <div class="course-description">
          <p> 5pc Chicken Nuggets </p>
        </div>
        <div class="course-price">$4.99 | 15 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#fishsticks').on('click', function(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://www.tasteaholics.com/wp-content/uploads/2019/01/Crispy-Baked-Fish-Sticks-feature.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Fishsticks</div>
        <div class="course-description">
          <p> 6 Crunchy fishsticks</p>
        </div>
        <div class="course-price">$4.99 | 8 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#sandwich').on('click', function(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://www.officiallyglutenfree.com/wp-content/uploads/2020/03/Low-Carb-Chicken-Club-Sandwich-17.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Club Sandwhiches</div>
        <div class="course-description">
          <p> 4 lettuce wrap club sandwhiches, topped with cheese, turkey, ham, and bacon.</p>
        </div>
        <div class="course-price">$4.99 | 2 carbs</div>
      </div>
      <div class="form-group">
    <label for="exampleFormControlSelect1">Select A Side</label>
    <select style="width: 45vw" class="form-control" id="exampleFormControlSelect1">
...
$('#desserts').click(function renderDesserts(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://www.fittoservegroup.com/wp-content/uploads/2020/02/keto-blueberry-cheesecake-on-white-plate-2-2-720x720.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Blueberry Cheesecake</div>
        <div class="course-description">
          <p> Slice of blueberry cheesecake. </p>
        </div>
        <div class="course-price">$5.99 | 9 carbs</div>
      </div>
      <div class="form-group">
...
$('#doublechocolate').on('click', function(){
  $('.main').empty();
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://www.thespruceeats.com/thmb/hSpbo9r3zma8clXXd-mXeqzu7l4=/1332x1332/smart/filters:no_upscale()/keto-chocolate-cookies-4769153-hero-01-a4287551d0eb4d86a4bc3bb0afb6c6d8.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Double Chocolate Chip</div>
        <div class="course-description">
          <p> 4 large double chocolate chip cookies. </p>
        </div>
        <div class="course-price">$4.99 | 4 carbs</div>
      </div>
      <div class="form-group">
...
$('#classic').on('click', function(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://www.ketoconnect.net/wp-content/uploads/2020/12/close-up-pile-of-cookies-with-sea-salt.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Classic Chocolate Chip Cookies.</div>
        <div class="course-description">
          <p> 4 large classic chocolate chip cookies.</p>
        </div>
        <div class="course-price">$4.99 | 4 carbs</div>
      </div>
      <div class="form-group">
...
$('#brownie').on('click', function(){
  ...
  let burgerDetails = (`
   ...
   <div class="selected-order">
     ...
     <div class="course">
  <div class="dinner">
    <img src="https://joyfilledeats.com/wp-content/uploads/2017/10/keto-vanilla-ice-cream-1-500x375.jpg"/>  
      </div> 
  </div>
  ...
  <div class="course-info">
        <div class="course-name">Brownie and Vanilla Ice Cream</div>
        <div class="course-description">
          <p> Keto brownie, with a scoop of Halo Top, vanilla ice cream.</p>
        </div>
        <div class="course-price">$6.99 | 6 carbs</div>
      </div>
      <div class="form-group">
