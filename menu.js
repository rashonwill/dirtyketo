...
$('#salads').click(function renderSalads(){
  ...
  <div class="card-body">
    <p class="card-text">Shrimp Avacoda and Tomato Salad</p>
    <a href="#" class="btn">Order</a>
  </div>
</div>  
...
$('#charcuterie').click(function renderChacuterie(){
  ...
  <div class="card-body">
    <p class="card-text">The Fullfillment</p>
    <a href="#" class="btn">Order</a>
  </div>
</div>  
  ...
  <div class="card-body">
    <p class="card-text">The Very Bery</p>
    <a href="#" class="btn">Order</a>
  </div>
</div>     
...
$('#lunches').click(function renderLunches(){
  ...
  <div class="card-body">
    <p class="card-text">Cabage and Sausage Bowl</p>
    <a href="#" class="btn">Order</a>
  </div>
</div>  
...
$('#kids').click(function renderKids(){
  ...
  <div class="card-body">
    <p class="card-text">Club Sandwhiches</p>
    <a href="#" class="btn">Order</a>
  </div>
</div>     
